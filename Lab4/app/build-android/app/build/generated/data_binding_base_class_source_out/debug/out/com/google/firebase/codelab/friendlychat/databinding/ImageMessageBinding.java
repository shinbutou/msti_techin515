...
public final class ImageMessageBinding implements ViewBinding {
  @NonNull
  ...
  private ImageMessageBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView messageImageView, @NonNull ImageView messengerImageView,
      @NonNull TextView messengerTextView) {
  ...
  @NonNull
  public static ImageMessageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ImageMessageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.image_message, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ImageMessageBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.messageImageView;
      ...
      return new ImageMessageBinding((ConstraintLayout) rootView, messageImageView,
          messengerImageView, messengerTextView);
    }
